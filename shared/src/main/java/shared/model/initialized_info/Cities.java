...
public class Cities implements Serializable {
    ...
    private City mont = new City(new Point(956, 83), MONTREAL);
    private City seat = new City(new Point(131, 68), SEATTLE);
    ...
    private City stm = new City(new Point(737, 144), SAUL_ST_MARIE);
    private City tor = new City(new Point(841, 171), TORONTO);
    private City bost = new City(new Point(976, 171), BOSTON);
    private City nyc = new City(new Point(935, 240), NEW_YORK);
    private City pitt = new City(new Point(839, 269), PITTSBURGH);
    private City wash = new City(new Point(892, 329), WASHINGTON);
    private City chic = new City(new Point(715, 269), CHICAGO);
    private City omhC = new City(new Point(521, 395), OKLAHOMA_CITY);
    private City omh = new City(new Point(554, 264), OMAHA);
    private City dvr = new City(new Point(384, 311), DENVER);
    private City kanC = new City(new Point(560, 327), KANSAS_CITY);
    private City stL = new City(new Point(644, 336), ST_LOUIS);
    ...
    private City newO = new City(new Point(667, 543), NEW_ORLEANS);
    private City lRock = new City(new Point(614, 417), LITTLE_ROCK);
    private City hou = new City(new Point(580, 540), HOUSTON);
    private City dal = new City(new Point(560, 503), DALLAS);
    private City elP = new City(new Point(345, 480), EL_PASO);
    private City sanFe = new City(new Point(357, 399), SANTA_FE);
    private City phx = new City(new Point(236, 429), PHOENIX);
    private City lasV = new City(new Point(197, 369), LAS_VEGAS);
    private City lax = new City(new Point(131, 416), LOS_ANGELES);
    private City sanFr = new City(new Point(65, 306), SAN_FRANCISCO);
    private City slc = new City(new Point(261, 264), SALT_LAKE_CITY);
