...
public class Routes implements Serializable {
    ...
    private void setRoutes(){
        ...
        this._routesMap.put(_1b, new Route(1, cities.getVanc(), cities.getSeat(), Color.GRAY, false));
        this._routesMap.put(_2, new Route(1, cities.getSeat(), cities.getPort(), Color.GRAY,false));
        ...
        this._routesMap.put(_10, new Route(5, cities.getPort(), cities.getSanFr(), Color.GREEN, false));
        ...
        this._routesMap.put(_11b, new Route(5, cities.getSanFr(), cities.getSlc(), Color.WHITE, false));
        this._routesMap.put(_12, new Route(3, cities.getSanFr(), cities.getLax(), Color.PINK, false));
        this._routesMap.put(_12b, new Route(3, cities.getSanFr(), cities.getLax(), Color.YELLOW, false));
        ...
        this._routesMap.put(_17b, new Route(3, cities.getSlc(), cities.getDvr(), Color.YELLOW, false));
        ...
        this._routesMap.put(_26 , new Route(1, cities.getHou(), cities.getDal(), Color.GRAY, false));
        ...
        this._routesMap.put(_28b , new Route(4, cities.getNewO(), cities.getAtl(), Color.YELLOW, false));
        ...
        this._routesMap.put(_34 , new Route(2, cities.getAtl(), cities.getRal(), Color.GRAY, false));
        ...
        this._routesMap.put(_36 , new Route(2, cities.getRal(), cities.getWash(), Color.GRAY, false));
        ...
        this._routesMap.put(_39 , new Route(2, cities.getWash(), cities.getNyc(), Color.ORANGE, false));
        ...
        this._routesMap.put(_41b , new Route(2, cities.getNyc(), cities.getBost(), Color.YELLOW, false));
        ...
        this._routesMap.put(_44 , new Route(2, cities.getBost(), cities.getMont(), Color.GRAY, false));
        ...
        this._routesMap.put(_62 , new Route(2, cities.getDal(), cities.getOmhC(), Color.GRAY, false));
        this._routesMap.put(_62b , new Route(2, cities.getDal(), cities.getOmhC(), Color.GRAY, false));
        this._routesMap.put(_63 , new Route(2, cities.getOmhC(), cities.getKanC(), Color.GRAY, false));
        this._routesMap.put(_63b , new Route(2, cities.getOmhC(), cities.getKanC(), Color.GRAY, false));
        this._routesMap.put(_64 , new Route(1, cities.getKanC(), cities.getOmh(), Color.GRAY, false));
        this._routesMap.put(_64b , new Route(1, cities.getKanC(), cities.getOmh(), Color.GRAY, false));
        this._routesMap.put(_65 , new Route(2, cities.getOmh(), cities.getDul(), Color.GRAY, false));
        ...
        this._routesMap.put(_72 , new Route(4, cities.getKanC(), cities.getDvr(), Color.ORANGE, false));
        this._routesMap.put(_72b , new Route(4, cities.getKanC(), cities.getDvr(), Color.BLACK, false));
